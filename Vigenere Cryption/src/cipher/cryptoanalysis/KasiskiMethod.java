...
public class KasiskiMethod {
    ...
    public int getKeywordLength(String cipherText) {
        List<Repeat> list = findRepeatedGramms(cipherText);
    ...
    private List<Repeat> findRepeatedGramms(String cipherText) {
        ...
        return (List<Repeat>) results.values().stream().collect(Collectors.toList());
    }
    ...
    private int findDistancesGCD(Repeat repeat) {
